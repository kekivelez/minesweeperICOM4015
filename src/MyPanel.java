...
public class MyPanel extends JPanel {
	...
	public MyPanel() {   //This is the constructor... this code runs first to initialize
		...
		for(int x=0; x<5; x++){	//draws mines
			for(int y=0;y<2;y++){
				if(detonate){
					randX = generator.nextInt(TOTAL_COLUMNS);
					randY = generator.nextInt(TOTAL_ROWS);
					colorArray[randX][randY] = Color.BLACK;
				}
				else
					colorArray[randX][randY] = Color.WHITE;
			}
		}
	}
